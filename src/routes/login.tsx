...
function LoginPage() {
  ...
  return (
    <AuthShell title="Welcome back." sub="Sign in to continue building.">
      ...
      <div className="hidden lg:block bg-foreground text-background p-12 relative overflow-hidden">
        ...
        <div className="absolute inset-x-12 bottom-12">
          ...
          <h2 className="mt-4 font-display text-5xl leading-tight">
            A résumé that
            <br />
            <span className="italic opacity-80">reads beautifully.</span>
          </h2>
        </div>
      </div>
      <div className="flex items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-sm">
          <Link to="/" className="font-display text-xl lg:hidden">
            CeeVeeForYou
          </Link>
